            ...
            >
              <div className="flex flex-col items-center mr-4 rtl:mr-0 rtl:ml-4">
                ...
                >
                  {Icon ? (
                    ...
                    <DefaultIcon
                      className={twMerge('w-10 h-10 p-2 rounded-full border-2', iconClass)}
                    />
                  ) : null}
                </div>
              ...
              <div className={`pt-1 ${index !== items.length - 1 ? 'pb-8' : ''}`}>
                {title && (
                  <h3
                    className={twMerge(
                      'text-xl font-bold text-gray-900 dark:text-slate-300 mb-2',
                      titleClass,
                    )}
                  >
                    {title}
                ...
                {description && (
                  <p className={twMerge('text-gray-600 dark:text-slate-400', descriptionClass)}>
                    {description}
                  </p>
                )}
              </div>
